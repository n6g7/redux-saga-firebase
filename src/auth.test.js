...
describe('auth', () => {
  ...
  describe('signInWithCredential(credential)', () => {
    it('returns a user', () => {
      ...
      const iterator = authModule.signInWithCredential.call(
        context,
        credential
      );
  ...
  describe('signInWithRedirect(authProvider)', () => {
    it('returns nothing', () => {
      const authProvider = 'skqdk';
      const iterator = authModule.signInWithRedirect.call(
        context,
        authProvider
      );
  ...
  describe('signUpWithEmailAndPassword(email, password)', () => {
    it('returns a user', () => {
      ...
      expect(iterator.next().value).toEqual(
        call([auth, auth.signUpWithEmailAndPassword], email, password)
      );
