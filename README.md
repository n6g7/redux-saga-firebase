...
- [`*auth.updatePassword()`](https://n6g7.github.io/redux-saga-firebase/reference/auth#updatePassword)
- [`*auth.sendEmailVerification()`](https://n6g7.github.io/redux-saga-firebase/reference/auth#sendEmailVerification)
